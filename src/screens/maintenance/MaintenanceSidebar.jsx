...
const MENU_SECTIONS = [
  ...
  { key: 'mytasks', icon: 'construct-outline', label: 'My Requests' },
  { key: 'history', icon: 'time-outline', label: 'History' },
];

/**
 * MaintenanceSidebar — left navigation for the new Maintenance staff
 * portal. Same shape/behavior as HousekeepingSidebar.jsx/FnbSidebar.jsx.
 */
export default function MaintenanceSidebar({
  activeKey,
  onNavigate,
  onLogout,
  staffName = 'Maintenance Staff',
  staffPhotoUrl,
  collapsed = false,
  onClose,
  myTasksBadgeCount = 0,
      ...
      <View style={styles.profileFooter}>
        ...
        >
          ...
          <View style={styles.profileTextWrap}>
            ...
            <Text style={styles.profileRole} numberOfLines={1}>Maintenance</Text>
          </View>
        </TouchableOpacity>
